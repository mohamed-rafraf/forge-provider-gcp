...
func newClusterManagerClient(ctx context.Context, credentialsRef *corev1.SecretReference, crClient client.Client) (*container.ClusterManagerClient, error) {
	opts, err := defaultClientOptions(ctx, credentialsRef, crClient)
	if err != nil {
		return nil, fmt.Errorf("getting default gcp client options: %w", err)
	}
...
func newIamCredentialsClient(ctx context.Context, credentialsRef *corev1.SecretReference, crClient client.Client) (*credentials.IamCredentialsClient, error) {
	opts, err := defaultClientOptions(ctx, credentialsRef, crClient)
	if err != nil {
		return nil, fmt.Errorf("getting default gcp client options: %w", err)
	}
...
func newInstanceGroupManagerClient(ctx context.Context, credentialsRef *corev1.SecretReference, crClient client.Client) (*computerest.InstanceGroupManagersClient, error) {
	opts, err := defaultClientOptions(ctx, credentialsRef, crClient)
	if err != nil {
		return nil, fmt.Errorf("getting default gcp client options: %w", err)
	}
...
func newTagBindingsClient(ctx context.Context, credentialsRef *corev1.SecretReference, crClient client.Client, location string) (*resourcemanager.TagBindingsClient, error) {
	opts, err := defaultClientOptions(ctx, credentialsRef, crClient)
