...
//		Build()
//
//	clusterScope, err := scope.NewBuildScope(context.TODO(), scope.BuildScopeParams{
//		Client:     fakec,
//		Build:    fakeBuild,
//		GCPBuild: fakeGCPCluster,
